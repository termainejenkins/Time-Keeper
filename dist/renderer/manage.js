...
const App = () => {
    ...
    const [previewTimeLeft, setPreviewTimeLeft] = (0, react_1.useState)(30 * 1000);
    const [isPreviewAnimating, setIsPreviewAnimating] = (0, react_1.useState)(false);
    // Calculate preview border color
    const getPreviewBorderColor = () => {
        if (!hudSettings.dynamicBorderColor)
            return hudSettings.borderColors.normal;
        const secondsLeft = previewTimeLeft / 1000;
        if (secondsLeft <= 5)
            return hudSettings.borderColors.critical;
        if (secondsLeft <= 15)
            return hudSettings.borderColors.warning;
        return hudSettings.borderColors.normal;
    };
    ...
    const [startupSettings, setStartupSettings] = (0, react_1.useState)(defaultStartupSettings);
    ...
    const handleStartupSettingsChange = async (newSettings) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            boxSizing: 'border-box',
                    ...
                    boxSizing: 'border-box',
                                            ...
                                            fontWeight: 500,
                                            transition: 'background 0.2s, border 0.2s',
                                        }, children: "Reset to Defaults" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { marginTop: 40, borderTop: '1px solid #eee', paddingTop: 24 }, children: [(0, jsx_runtime_1.jsx)("h3", { style: { fontWeight: 600, fontSize: 18, marginBottom: 16, color: hudSettings.darkMode ? '#f3f3f3' : '#222' }, children: "Startup Options" }), (0, jsx_runtime_1.jsxs)("div", { style: { color: hudSettings.darkMode ? '#f3f3f3' : '#222', fontSize: 16, maxWidth: 400 }, children: [(0, jsx_runtime_1.jsxs)("label", { style: { display: 'flex', alignItems: 'center', marginBottom: 18, gap: 10 }, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: startupSettings.autoStart, onChange: e => handleStartupSettingsChange({ ...startupSettings, autoStart: e.target.checked }) }), "Enable scheduled startup"] }), startupSettings.autoStart && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: 18, paddingLeft: 24 }, children: [(0, jsx_runtime_1.jsx)("label", { style: { display: 'block', marginBottom: 8 }, children: "Start Time:" }), (0, jsx_runtime_1.jsx)("input", { type: "time", value: startupSettings.startTime, onChange: e => handleStartupSettingsChange({ ...startupSettings, startTime: e.target.value }), style: { padding: '4px 8px', borderRadius: 4 } })] }), (0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: 18, paddingLeft: 24 }, children: [(0, jsx_runtime_1.jsx)("label", { style: { display: 'block', marginBottom: 8 }, children: "Start Days:" }), (0, jsx_runtime_1.jsx)("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 8 }, children: ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map(day => ((0, jsx_runtime_1.jsxs)("label", { style: { display: 'flex', alignItems: 'center', gap: 4 }, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: startupSettings.startDays.includes(day), onChange: e => {
                                                                            ...
                                                                            } }), day.charAt(0).toUpperCase() + day.slice(1)] }, day))) })] })] })), (0, jsx_runtime_1.jsxs)("label", { style: { display: 'flex', alignItems: 'center', marginBottom: 18, gap: 10 }, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: startupSettings.startWithWindows, onChange: e => handleStartupSettingsChange({ ...startupSettings, startWithWindows: e.target.checked }) }), "Start with Windows"] })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: {
                                    marginTop: 40,
