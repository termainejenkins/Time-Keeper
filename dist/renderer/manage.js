    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            boxSizing: 'border-box',
                    ...
                    boxSizing: 'border-box',
                                            ...
                                            fontWeight: 500,
                                            transition: 'background 0.2s, border 0.2s',
                                        }, children: "Reset to Defaults" })] })] })), selected === 'startup' && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h2", { style: { fontWeight: 700, fontSize: 24, marginBottom: 16, color: hudSettings.darkMode ? '#f3f3f3' : '#222' }, children: "Startup Options" }), (0, jsx_runtime_1.jsxs)("div", { style: { color: hudSettings.darkMode ? '#f3f3f3' : '#222', fontSize: 16, maxWidth: 400 }, children: [(0, jsx_runtime_1.jsxs)("label", { style: { display: 'flex', alignItems: 'center', marginBottom: 18, gap: 10 }, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: startupSettings.autoStart, onChange: e => handleStartupSettingsChange({ ...startupSettings, autoStart: e.target.checked }) }), "Enable scheduled startup"] }), startupSettings.autoStart && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { style: { marginLeft: 24, marginBottom: 18 }, children: [(0, jsx_runtime_1.jsx)("label", { style: { display: 'block', marginBottom: 8 }, children: "Start Time:" }), (0, jsx_runtime_1.jsx)("input", { type: "time", value: startupSettings.startTime, onChange: e => handleStartupSettingsChange({ ...startupSettings, startTime: e.target.value }), style: { padding: '4px 8px', borderRadius: 4 } })] }), (0, jsx_runtime_1.jsxs)("div", { style: { marginLeft: 24, marginBottom: 18 }, children: [(0, jsx_runtime_1.jsx)("label", { style: { display: 'block', marginBottom: 8 }, children: "Start Days:" }), ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map(day => ((0, jsx_runtime_1.jsxs)("label", { style: { display: 'flex', alignItems: 'center', marginBottom: 8, gap: 8 }, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: startupSettings.startDays.includes(day), onChange: e => {
